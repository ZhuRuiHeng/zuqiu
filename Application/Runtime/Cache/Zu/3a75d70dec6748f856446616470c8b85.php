<?php if (!defined('THINK_PATH')) exit();?><html>
	<head>
		...
		<script>
		if(top.hasLogin != 'login') {window.open('about:blank','_top')};
		if(self == top) location='http://66.133.87.55';
		top.CM = new CookieManager();
		top.SortType = top.CM.get('SortType@17041417')
		top.odd_f_type = top.CM.get('OddType@17041417')
		if(top.CM.get('more_fave_wtype@17041417') != undefined) top.more_fave_wtype = top.CM.get('more_fave_wtype@17041417').split(',')
		</script>
		...
		<style>
		.bg_position { position:fixed; position:absolute;}
		</style>
		
		<script>
			
		//2016.0412 Leslie精選賽事改特別賽事
		top.hot_type = "SP";
		...
		function chgSiteFinish(){	
				var h = document.getElementById("i_site").contentWindow.document.body.scrollHeight;
				//var h = document.getElementById("tab_show").clientHeight;
				//document.getElementById("show_site").style.height = h+"px";
				//document.getElementById("show_site").style.display = "";
				//alert(h);
		}
		...
		function initlid_SK(){
			...
			top.SK_lid['SK_lid_ary']= SK_lid_ary='ALL';
			top.SK_lid['SK_lid_type']= SK_lid_type='';
			top.SK_lid['SK_lname_ary']= SK_lname_ary='ALL';
			top.SK_lid['SK_lid_ary_RE']= SK_lid_ary_RE='ALL';
			top.SK_lid['SK_lname_ary_RE']= SK_lname_ary_RE='ALL';
			top.SKFU_lid['SKFU_lid_ary']= SKFU_lid_ary='ALL';
			top.SKFU_lid['SKFU_lid_type']= SKFU_lid_type='';
			top.SKFU_lid['SKFU_lname_ary']= SKFU_lname_ary='ALL';
			top.FSSK_lid['FSSK_lid_ary']= FSSK_lid_ary='ALL';
			top.FSSK_lid['FSSK_lname_ary']= FSSK_lname_ary='ALL'	
		}
		function initlid_OP(){
		...
		function display_loading(visible){
			//console.log(visible);
			document.getElementById("loading").style.display=(visible==true?"":"none");
		...
		function showerror(e){
			...
			//2017-0203-johnson- 3.連線判斷
			//e.times+=1;
			//if(e.times > 10)	return;
			setTimeout(function(){e.contentWindow.location=e.loadsrc;},5000);
			
		}
		function show_chg_div(show){
			if(show){
				document.getElementById("show_site").style.display='';
				var show_hei=document.getElementById("i_site").contentWindow.document.body.scrollHeight;
				var body_hei=document.getElementById("body_site").scrollHeight;
				if(body_hei>=show_hei) 
				{
					document.getElementById("i_site").contentWindow.document.getElementById("bsDIV").style.height=body_hei+"px";
				}else{
					document.getElementById("i_site").contentWindow.document.getElementById("bsDIV").style.height=show_hei+"px";
				}
			}else{
				document.getElementById("show_site").style.display='none';
			}
			
		}
		
		//   FT_index.html joe 160408
		showGtype = top.gtypeShowLoveI;
		if(showGtype==null) initDate();
		function initDate(){
			top.gtypeShowLoveI =new Array("FTRE","FT","FU","BKRE","BK","BU","BSRE","BS","BSFU","TNRE","TN","TU","VBRE","VB","VU","BMRE","BM","BMFU","TTRE","TT","TTFU","SKRE","SK","SKFU","OPRE","OP","OM");
...
<body id="body_site" bgcolor="#FFFFFF" style="overflow:hidden; margin:0; padding:0;">
<link rel="stylesheet" href="__/Public/css/mem_header_ft_cn.css" type="text/css">
<iframe src="<?php echo U('Old/showNotice');?>" id="SI2_notice" scrolling="no" frameborder="NO" border="0" framespacing="0" noresize="" topmargin="0" leftmargin="0" marginwidth="0" marginheight="0" allowtransparency="true" height="100%" width="100%" class="bg_position" style="display: none;"></iframe>
	<!--div id="show_site"  style="display:none;position:absolute;top:0px;left:0px;width:100%;height:100%;"-->
	<div id="show_site" style="display:none;position:absolute;top:0px;left:0px;width:100%;height:100%;">
		<iframe id="i_site" onload="iframe_onError(this,showerror);chgSiteFinish();" allowtransparency="true" scrolling="auto" noresize="" src="<?php echo U('Old/chg_site');?>" width="100%" height="100%" frameborder="0"></iframe>
	</div>	
	
	<table id="tab_show" width="100%" height="100%" border="0" cellpadding="0" cellspacing="0"> 
		<tbody><tr>
			<td height="118" colspan="2">
				<iframe onload="iframe_onError(this,showerror);" id="header" name="header" scrolling="NO" noresize="" src="<?php echo U('Old/FT_header');?>" width="100%" height="118px" frameborder="0"></iframe>
			</td>
		</tr>
		<!--frameset cols="240,1*" frameborder="NO" border="0" framespacing="0"--> 
		<tr>
			<td width="240">
				<iframe onload="iframe_onError(this,showerror);" id="mem_order" name="mem_order" noresize="" scrolling="NO" src="<?php echo U('Old/select');?>" width="100%" height="100%" frameborder="0"></iframe>
			</td>
			<td valign="top">
				<div style="width: 100%; height: 100%; background: url(&quot;/images/member/load_alpha.png&quot;) 0px 0px repeat; display: none;" id="loading" class="bg_position">
                <!--div style=" width:900px; height:165px; background:url(../../images/member/loading_body.jpg) no-repeat 0 0;"></div-->
					<img src="/images/member/loading_pic.gif" width="38" height="38" style="margin-top:245px; margin-left:362px;">
				</div>
				<div id="body_view" name="body_view" style="display:;width:100%;height:100%;">
					<iframe onload="iframe_onError(this,showerror);" id="body" name="body" src="<?php echo U('Old/FT_browse');?>" width="100%" height="100%" frameborder="0"></iframe>
				</div>
			</td>
		</tr>
	</tbody>
