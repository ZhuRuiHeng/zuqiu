...
<div class="acc_leftMain">
    ...
    <div class="acc_term_DataMain">
        ...
        <ul>
            <li>
                享用本公司提供的服务是客户本人的意愿，其风险应由客户本人承担。参与我们服务的同时就说明客户认同本公司所提供的服务是正常、合理、公正、公平的。
            </li>
            <li>
        ...
        <ul>
            ...
            <li>
                所有在本公司客户账户交易记录显示确认信息的注单，本司都视为有效注单。每笔交易完成后，请查您的交易记录，若有任何问题请联系上线核查，否则您接受您的注单是正确的。
            </li>
            <li>
                如果客户有欺诈，合谋，非法或其它不当行为，我们有权(唯一决定人)取消投注单或任何彩金。
            </li>
            <li>
